                    ...
                    reviews.map(review => {
                        return (
                            <Card mode='outline' key={review.uid}>
                                ...
                                <div style={{ display: 'flex', margin: '-30px 9px 5px auto', float: 'right' }}>
                                    ...
                                    <div>Подтверждение удаления<br/>
                                        <div>
                                            ...
                                            <Button mode='tertiary' hasHover={false} style={{ color: '#fff' }}>Отмена</Button>
                                        </div>
                                    </div>} isShown={tooltipDelete}>
                                        <PanelHeaderButton onClick={() => setTooltipDelete(true)} style={{ padding: 7 }}><Icon20DeleteOutlineAndroid width={16} height={16} fill='red'/></PanelHeaderButton>
                                    </Tooltip>
                                </div>}
                            </Card>
                        )
